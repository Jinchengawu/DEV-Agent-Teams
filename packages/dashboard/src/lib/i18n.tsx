...
const STORAGE_KEY = 'dev-agent-locale';
const SETTINGS_KEY = 'dev-agent-settings';
...
export const dictionaries: Record<Locale, TranslationDictionary> = {
  zh: {
    ...
    'hero.eyebrow': 'AI SOFTWARE DELIVERY TEAM FOR REAL BUSINESS PROJECTS',
    'hero.title': '让 AI Agent 不只会回答，而是能按软件团队方式交付。',
    'hero.subtitle': 'DEV-Agent-Teams 是面向软件研发组织的 AI 团队协同平台。它把 PM、研发、测试、DevOps Agent 接入同一条交付循环，用 PRD、看板、工作流、验证报告和复盘经验承载结果，帮助企业从“试用 Agent”走向“部署 AI 开发团队”。',
    'hero.primary': '申请真实项目试点',
    'hero.secondary': '查看交付看板',
  ...
  en: {
    ...
    'nav.brandSubtitle': 'TEAM COORDINATION OS',
    'hero.eyebrow': 'AI SOFTWARE DELIVERY TEAM FOR REAL BUSINESS PROJECTS',
    'hero.title': 'Make AI Agents deliver like a software team, not just answer questions.',
    'hero.subtitle': 'DEV-Agent-Teams is an AI team coordination platform for software organizations. It connects PM, engineering, testing, and DevOps agents into one delivery loop, grounding outcomes in PRDs, kanban, workflows, verification reports, and retrospectives.',
    'hero.primary': 'Apply for a pilot',
    'hero.secondary': 'Open delivery board',
